...
begin
	...
	function load_trend_array_2020()
		f = jldopen("./svr_gpp_annual_spatial_trend_2020.jld2")
		trend_array = f[dataset]
		trend_array = convert(Array{Union{Missing, Float32}}, trend_array)
		replace!(trend_array, -9999.0 => missing)
		return trend_array
	...
	function load_trend_array_2015()
		f = jldopen("./svr_gpp_annual_spatial_trend_2015.jld2")
		trend_array = f[dataset]
		trend_array = convert(Array{Union{Missing, Float32}}, trend_array)
		replace!(trend_array, -9999.0 => missing)
		return trend_array
	...
	trend_array_2020 = load_trend_array_2020()
	trend_array_2015 = load_trend_array_2015()
	nothing
end
...
begin
	...
	create_differential_maps(trend_array)
end
...
manifest_format = "2.0"
project_hash = "046a4e27dde50af52d90d4384bfe885314493715"
