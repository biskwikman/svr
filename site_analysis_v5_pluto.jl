...
# ╔═╡ 633bdfe6-8813-11ee-25c3-170b012e4123
begin
	using CSV
	using DataFrames
	using CairoMakie
...
# ╔═╡ 6af5d2ce-d2a7-4a1f-921e-a5c809bd1bf8
begin
...
# ╔═╡ 917cde4c-3693-4ab0-917d-e109b195c23b
begin
	...
	input_df = DataFrame(CSV.File("./prep_input_c5/svr.test.ALL.GPP.201.txt", header=false))
	input_df[!, "id"] = string.(input_df[:, 1], "_", input_df[:, 2], "_", input_df[:, 3])
	y_i = []
	y_i_forest = []
	y_i_nonforest = []
	for ens in 201:210
		output_file = @sprintf("./CROSSVAL_c5/output_lvmar/CV_%i_ALL_GPP.csv", ens)
...
# ╔═╡ 3151b6be-84d2-4526-8d20-5a9626cfc4bf
begin
...
# ╔═╡ e317f65b-d8ab-48c9-a39b-95bc9e7112a0
begin
...
# ╔═╡ db6bb9f0-2060-4d88-86c0-55e6256d3c80
html"""<style>
main {
    max-width: 60%;
    margin-left: 50px;
